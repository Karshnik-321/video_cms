...
import { BarsArrowUpIcon, ChevronDownIcon, UsersIcon } from '@heroicons/react/20/solid'
const navigation = [
              ...
              <form>
                <div className="space-y-12">
                  ...
                  <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
                    ...
                    <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                      <div className="col-span-full">
                        <label htmlFor="first-name" className="block text-sm font-medium leading-6 text-gray-900"> Entry Date & Time </label>
                        <div className="mt-2">
                          <input
                            type="date"
                            value="Wed, Jan 12"
                      ...
                      <div className="col-span-full">
                        <label htmlFor="first-name" className="block text-sm font-medium leading-6 text-gray-900">Platform</label>
                        <div className="mt-2">
                          <input
                            type="text"
                            value="YouTube"
                      ...
                      <div className="col-span-full">
                        <label htmlFor="first-name" className="block text-sm font-medium leading-6 text-gray-900">Editing Date</label>
                        <div className="mt-2">
                          <input
                            type="text"
                            value=""
                      ...
                      <div className="col-span-full">
                        <label htmlFor="first-name" className="block text-sm font-medium leading-6 text-gray-900">Email ID</label>
                        <div className="mt-2">
                          <input
                            type="text"
                      ...
                      <div className="col-span-full">
                        <label htmlFor="first-name" className="block text-sm font-medium leading-6 text-gray-900">Editor Name</label>
                        <div className="mt-2">
                          <input
                            type="text"
                            value="Jatin Kumar"
                      ...
                      <div className="col-span-full">
                        <label htmlFor="first-name" className="block text-sm font-medium leading-6 text-gray-900">Team</label>
                        <div className="mt-2">
                          <input
                            type="text"
                            value="Editorial"
                      ...
                      <div className="col-span-full">
                        <label htmlFor="first-name" className="block text-sm font-medium leading-6 text-gray-900">Music Link</label>
                        <div className="mt-2">
                          <input
                            type="text"
                            value=""
                      ...
                      <div className="col-span-full">
                        <label htmlFor="first-name" className="block text-sm font-medium leading-6 text-gray-900">Campaign Name</label>
                        <div className="mt-2">
                          <input
                            type="text"
                            value=""
                      ...
                      <div className="col-span-full">
                        <label htmlFor="first-name" className="block text-sm font-medium leading-6 text-gray-900">Other Music Links</label>
                        <div className="mt-2">
                          <input
                            type="text"
                            value=""
